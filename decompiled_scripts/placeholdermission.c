...
void func_3()
{
	...
	if (Global_112293.f_9083 || func_19(0))
	{
		if (!func_18())
		{
			iVar0 = func_17();
...
void func_6()
{
	...
	{
		if (func_10(Global_112293.f_2361.f_539.f_4321) != unk_0x6471F4759775FCA4(unk_0x7D2B9E6A64637269()))
		{
			iVar0 = func_9(unk_0x7D2B9E6A64637269());
			if (func_8(iVar0) && (!func_7(14) || Global_111244))
			{
