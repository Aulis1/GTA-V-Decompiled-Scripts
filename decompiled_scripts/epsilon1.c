	...
	switch (iLocal_145)
	{
		case 0:
			...
			if (func_214(iLocal_147))
			{
				...
				unk_0x2271ED1E65FB75EE(iLocal_147, 1862763509);
...
void func_294(int iParam0, var uParam1)
{
	...
	if (!unk_0xECEC7528A52B4EE8(iParam0))
	{
		...
		while (iVar0 <= (44 - 1))
		{
			...
			if (iVar3 != 0)
			{
				Var4 = unk_0x2CBBA235A635CC58(iParam0, func_299(iVar0));
				Var4.f_1 = 0;
				Var4.f_2 = 0;
				Var4.f_3 = 0;
				Var4.f_4 = 0;
		...
		while (iVar7 < 2)
		{
			...
			while (iVar8 < iVar72)
			{
				if (iVar8 < 51)
				{
					...
					{
						if (!unk_0xD1ABD511D9C326A3(Var9) && !func_296(Var9.f_1))
						{
							if (iVar7 == 0)
							{
...
int func_342(int iParam0)
{
	...
	while (iVar0 < unk_0xB3E2CBD7C8448401())
	{
		if (unk_0x0466DAD8CA6C1EAD(iVar0, &Var1))
		{
			if (Var1.f_1 == iParam0)
			{
				if (unk_0xD1ABD511D9C326A3(Var1) || func_296(Var1.f_1))
				{
					return 0;
				}
			}
