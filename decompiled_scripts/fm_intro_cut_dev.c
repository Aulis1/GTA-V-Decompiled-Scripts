...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		if (Global_1669793)
		{
			if (!Global_1669795)
			{
				Global_1669792 = unk_0x67D02A194A2FC2BD("OPENING_CREDITS");
				Global_1669795 = 1;
			}
			else if (GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(Global_1669792))
			{
				if (!Global_1669794)
				{
...
{
	if (func_179(PLAYER::PLAYER_ID()) && MISC::IS_BIT_SET(Global_1683970.f_4, 22))
	{
		return 0;
	}
	if (Global_1315714)
