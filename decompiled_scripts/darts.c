...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		{
			unk_0x32781653075794DC(Var477, Var477.f_18, Var477.f_21, Var477.f_24, Var477.f_24, 2);
		}
		...
		if (!unk_0xECEC7528A52B4EE8(uLocal_263[0]))
		{
			...
			switch (Var0)
			{
				...
				case 1:
					if (SYSTEM::TIMERA() > 500 && !unk_0x6B9E71121F5B8154(unk_0x7D2B9E6A64637269()))
					{
...
void func_15(var uParam0, float fParam1, bool bParam2)
{
	...
	if (fVar11 >= 0f)
	{
		...
		func_33();
		unk_0x80B2E30CC8B794C0(0.5f, (fVar1 - (func_37((2f - 0.5f)) - 0.001388889f)), fVar6, func_28(1f), iVar13, iVar14, iVar15, SYSTEM::ROUND((fVar12 * IntToFloat(iVar16))), 0);
	}
	else
	{
		return;
		...
		if (uParam0->f_556 == 4)
		{
			if (iVar17 == (uParam0->f_576 - 1))
			{
				...
				if (fVar11 >= 0f)
				{
					...
					fVar12 = func_14((fVar11 / (0.6f * func_37(25f))), 0f, 1f);
					func_33();
					unk_0x80B2E30CC8B794C0(0.5f, (fVar1 + func_37((2f * 0.5f))), fVar6, func_28(1f), iVar13, iVar14, iVar15, SYSTEM::ROUND((fVar12 * IntToFloat(iVar16))), 0);
					fVar1 = (fVar1 + func_37((2f * 0.3f)));
					if (uParam0->f_56 > 0)
					{
						fVar1 = (fVar1 + func_37((25f * 0.2f)));
...
void func_249(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4)
{
	...
	switch (uParam0->f_1)
	{
		...
		case 2:
			...
			else if (SYSTEM::TIMERA() > unk_0xB36B8558948EA7A8(1250, 2500))
			{
				func_292(&(uParam0->f_422), &(uParam0->f_249));
				func_289(&(uParam0->f_5[iLocal_30 /*79*/][iLocal_31 /*26*/]), &(uParam0->f_243), &(uParam0->f_1), &(uParam0->f_249), 0);
			}
...
void func_289(var uParam0, var uParam1, var uParam2, var uParam3, bool bParam4)
{
	...
	else
	{
		...
		*uParam0 = unk_0x795434E153F90E41(uParam0->f_1, Local_79, 0, 0, 0);
		...
		fVar2 = unk_0x832AD84AA258AE80((Var7.x - Var10.x), (Var7.f_1 - Var10.f_1));
		fVar2 = (fVar2 - 180f);
...
int func_305(var uParam0, var uParam1, bool bParam2)
{
	...
	fVar11 = unk_0x832AD84AA258AE80((Var3.x - Var6.x), (Var3.f_1 - Var6.f_1));
	fVar11 = (fVar11 - 180f);
	fVar9 = 90f;
...
int func_308(int iParam0, var uParam1, var uParam2, var uParam3)
{
	...
	switch (*uParam2)
	{
		...
		case 1:
			if (SYSTEM::TIMERB() > 3000 || unk_0x86AF801D34E482FF(2, 201))
			{
				func_309();
				*uParam2 = 0;
				return 1;
