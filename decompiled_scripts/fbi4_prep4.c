...
int func_176(var uParam0, var uParam1, var uParam2)
{
	...
	if (func_145(unk_0x6471F4759775FCA4(*uParam0), 1) && unk_0xB51972B58BF40F96(*uParam0, 24) != func_179(*uParam0, ((*uParam1)[38] - 1)))
	{
		unk_0x6895CB0D4F2E7CDC(*uParam0, 24, func_179(*uParam0, ((*uParam1)[38] - 1)), false);
	}
	func_178(uParam0);
	if (func_177(*uParam0))
	{
