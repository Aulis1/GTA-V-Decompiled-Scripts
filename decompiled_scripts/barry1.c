...
void func_70(int iParam0)
{
	...
	switch (*iParam0)
	{
		...
		case 4:
			...
			func_80(unk_0x7D2B9E6A64637269(), SYSTEM::FLOOR(fLocal_208), &iLocal_186);
			break;
...
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_311(unk_0x234B68AC2E35ED5A(iParam0, 31), -1, 1)) + 2011;
}
...
void func_344(int iParam0)
{
	switch (*iParam0)
	{
		...
		case 2:
			...
			if (unk_0xB30CD10E2CD1B67D(sLocal_340))
			{
				unk_0x12F409221DAE2366(sLocal_340, "DrugsEffect", ((SYSTEM::SIN((((SYSTEM::TO_FLOAT(unk_0xDFB7BFA6482FEE1E()) / 1000f) * 45f) % 360f)) * 0.25f) + 0.25f));
			}
...
void func_436(int iParam0, var uParam1)
{
	...
	if (!unk_0xECEC7528A52B4EE8(iParam0))
	{
		...
		while (iVar0 <= (44 - 1))
		{
			...
			if (iVar3 != 0)
			{
				Var4 = unk_0x2CBBA235A635CC58(iParam0, func_438(iVar0));
				Var4.f_1 = 0;
				Var4.f_2 = 0;
				Var4.f_3 = 0;
				Var4.f_4 = 0;
	...
	switch (uParam0->f_1)
	{
		case 1:
			if (unk_0xDFB7BFA6482FEE1E() > uParam0->f_7)
			{
				...
				uParam0->f_1 = 2;
				uParam0->f_15 = 0f;
				unk_0x93500360FCCB65F3(uParam0->f_2, SYSTEM::FLOOR(uParam0->f_15), 0);
			}
			break;
		...
		case 5:
			uParam0->f_15 = (IntToFloat((uParam0->f_7 - unk_0xDFB7BFA6482FEE1E()) * 255) / SYSTEM::TO_FLOAT(450));
			if (uParam0->f_15 < 0f)
			{
				uParam0->f_15 = 0f;
			}
		...
		case 8:
			uParam0->f_15 = (IntToFloat((uParam0->f_7 - unk_0xDFB7BFA6482FEE1E()) * 255) / SYSTEM::TO_FLOAT(1000));
			if (uParam0->f_15 < 0f)
			{
				uParam0->f_15 = 0f;
			}
				...
				if (unk_0x0BABEFEA577FCFA4(uParam0->f_27, Var2, 1) <= 0.7f)
				{
					...
					if (unk_0x0BCA9ADE67DF9DD8((uParam0->f_27.f_2 - Var2.f_2)) < 1f)
					{
						...
						if (unk_0xDFB7BFA6482FEE1E() > uParam0->f_8)
						{
							...
							uParam0->f_8 = (unk_0xDFB7BFA6482FEE1E() + SYSTEM::ROUND((IntToFloat(iLocal_854) * 1.25f)));
		...
		while (iVar7 < 2)
		{
			...
			while (iVar8 < iVar72)
			{
				if (iVar8 < 51)
				{
					...
					{
						if (!unk_0xD1ABD511D9C326A3(Var9) && !func_437(Var9.f_1))
						{
							if (iVar7 == 0)
							{
...
int func_572(int iParam0)
{
	...
	while (iVar0 < unk_0xB3E2CBD7C8448401())
	{
		if (unk_0x0466DAD8CA6C1EAD(iVar0, &Var1))
		{
			if (Var1.f_1 == iParam0)
			{
				if (unk_0xD1ABD511D9C326A3(Var1) || func_437(Var1.f_1))
				{
					return 0;
				}
			}
