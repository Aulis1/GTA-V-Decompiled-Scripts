...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		{
			case 0:
				if (unk_0xCA86FAB7FADC8353() == 3 && func_9())
				{
					iLocal_18 = 1;
				}
				break;
			...
			case 1:
				func_1(152, 1, 0, 1, 0);
				iLocal_18 = 2;
				if (!unk_0x30D4C42F75DEC781("AZ_SPECIAL_UFO_03"))
				{
					unk_0xF1C01CFF96F363D4("AZ_SPECIAL_UFO_03", 1, 1);
				}
				break;
...
void func_10()
{
	...
	if (unk_0x30D4C42F75DEC781("AZ_SPECIAL_UFO_03"))
	{
		unk_0xF1C01CFF96F363D4("AZ_SPECIAL_UFO_03", 0, 1);
	}
