...
void func_84(struct<3> Param0)
{
	...
	SCRIPT::TRIGGER_SCRIPT_EVENT(1, &Var0, 5, func_85(1, 1));
}
...
int func_88(int iParam0, bool bParam1, bool bParam2)
{
	...
	else if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (func_92() == 0)
		{
			return MISC::IS_BIT_SET(func_89(func_91(iParam0), -1, 0), bParam1);
		}
	}
	else
	{
...
{
	return func_114(bParam0, bParam1, 1);
}
...
int func_121(bool bParam0)
{
	if (bParam0 != func_66())
	{
		if (func_122(bParam0) && Global_2426865[bParam0 /*449*/].f_319.f_9 == bParam0)
		{
			return 1;
		}
	}
...
int func_202(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, int iParam5, int iParam6)
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
