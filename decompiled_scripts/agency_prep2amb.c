...
int func_205()
{
	if (SYSTEM::VDIST2(unk_0xD6E677FAD7521410(unk_0x7D2B9E6A64637269(), 1), 1276.123f, -1723.665f, 53.6551f) <= 52900f)
	{
		if (func_13())
		{
			func_69(30);
	...
	else if (SYSTEM::VDIST2(unk_0xD6E677FAD7521410(unk_0x7D2B9E6A64637269(), 1), 111.8564f, -751.7169f, 44.757f) <= 160000f)
	{
		if (func_13())
		{
			func_69(31);
