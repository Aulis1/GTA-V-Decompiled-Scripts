...
int func_14(bool bParam0, int iParam1)
{
	...
	bVar0 = bParam0;
	if (Global_1590908[bVar0 /*874*/] == iParam1)
	{
		return 1;
	}
	return 0;
...
bool func_23(bool bParam0)
{
	...
	return MISC::IS_BIT_SET(Global_1379108.f_241.f_136[func_25(10) /*33*/][bParam0], func_24(10));
}
...
bool func_28(bool bParam0, bool bParam1)
{
	...
	return Global_1630816[bParam0 /*597*/].f_11 != func_10();
}
...
int func_29(bool bParam0)
{
	if (bParam0 != func_10())
	{
		if (Global_1630816[bParam0 /*597*/].f_11 != func_10())
		{
...
{
	return Global_1590908[bParam0 /*874*/].f_192 != 0;
}
...
void func_38()
{
	...
	while (iVar2 < iVar1)
	{
		if (func_42() < 2)
		{
			if (MISC::IS_BIT_SET(Local_97[iVar2 /*4*/].f_1, true))
			{
			...
			if (MISC::IS_BIT_SET(Local_97[iVar2 /*4*/].f_1, false))
			{
...
int func_102(bool bParam0, int iParam1)
{
	if (func_33(bParam0, 0))
	{
		return func_100(Global_1630816[bParam0 /*597*/].f_11.f_33) == iParam1;
	}
	return 0;
}
...
void func_104()
{
	...
	if (!MISC::IS_BIT_SET(Local_97[NETWORK::PARTICIPANT_ID_TO_INT() /*4*/].f_1, 3))
	{
		...
		{
			func_105(151, MISC::IS_BIT_SET(Local_97[NETWORK::PARTICIPANT_ID_TO_INT() /*4*/].f_1, true), &Var0, 0);
		}
		MISC::SET_BIT(&(Local_97[NETWORK::PARTICIPANT_ID_TO_INT() /*4*/].f_1), 3);
	}
}
...
int func_113(bool bParam0)
{
	if (func_33(bParam0, 0))
	{
		return Global_1630816[bParam0 /*597*/].f_11.f_182;
	}
	return -1;
}
...
struct<13> func_184(bool bParam0)
{
	struct<13> Var0;
		...
		if (NETWORK::NETWORK_IS_PARTICIPANT_ACTIVE(iVar4))
		{
			...
			if (PLAYER::GET_PLAYER_TEAM(bVar5) != -1)
			{
				if (PLAYER::GET_PLAYER_TEAM(bVar5) == iVar1 || func_73(PLAYER::GET_PLAYER_TEAM(bVar5), iVar1, 0))
				{
					...
					{
						if (func_195(PLAYER::PLAYER_ID(), bVar5))
						{
							bVar3 = true;
						}
					}
...
int func_195(bool bParam0, bool bParam1)
{
	if (NETWORK::NETWORK_CLAN_SERVICE_IS_VALID())
	{
		Global_2518253 = { func_184(bParam0) };
		Global_2518266 = { func_184(bParam1) };
		...
		while (iVar0 < NETWORK::NETWORK_GET_MAX_NUM_PARTICIPANTS())
		{
			...
			if (NETWORK::NETWORK_IS_PARTICIPANT_ACTIVE(iVar3))
			{
				...
				if (func_9(bVar4, 0, 1))
				{
					...
					{
						iVar1++;
						if (func_195(PLAYER::PLAYER_ID(), bVar4))
						{
							bVar2 = true;
						}
					}
	...
	else
	{
		...
		while (iVar0 < 32)
		{
			...
			if (func_9(bVar4, 1, 1))
			{
				if (bVar4 != PLAYER::PLAYER_ID())
				{
					if (func_197(PLAYER::PLAYER_ID(), bVar4) <= 20f)
					{
						iVar1++;
						if (func_195(PLAYER::PLAYER_ID(), bVar4))
						{
...
float func_197(bool bParam0, bool bParam1)
{
	return SYSTEM::VDIST(func_198(bParam0), func_198(bParam1));
	return 0f;
}
...
{
	return func_116(func_32(bParam0));
}
...
void func_217(bool bParam0, int iParam1, int iParam2)
{
	struct<8> Var0;
	...
	if (func_9(bParam0, 0, 1))
	{
		...
		Var0.f_2 = iParam1;
		Var0.f_4 = iParam2;
		Var0.f_5 = func_219(bParam0);
		func_218(&(Var0.f_6), &(Var0.f_7));
		SCRIPT::TRIGGER_SCRIPT_EVENT(1, &Var0, 8, func_46(bParam0));
	}
}
...
int func_220(char* sParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, int iParam5)
{
	int iVar0;
	struct<8> Var1;
	...
	if (iParam0 == 237)
	{
		...
		if (bVar11 != -1)
		{
			...
			*uParam3 = iVar1;
			...
			{
				iVar2 = func_246(Global_1590908[bVar11 /*874*/].f_851, *uParam3);
			}
			if (uParam1->f_17)
			{
...
void func_231(bool bParam0, int iParam1, int iParam2)
{
	...
	uVar0 = func_233(bParam0);
	func_232(bParam0, uVar0, iParam1, iParam2);
}

void func_232(bool bParam0, var uParam1, var uParam2, var uParam3)
{
	struct<8> Var0;
...
int func_236(bool bParam0, int iParam1)
{
	...
	iVar0 = (func_297(bParam0) * func_237());
...
void func_250(int iParam0, var uParam1, int iParam2, var uParam3)
{
	...
	else if (iParam0 == 226)
	{
		...
		if (bVar15 != -1)
		{
			iVar16 = func_144(bVar15);
			iVar0 = (func_275(bVar15, iVar16) + uParam1->f_8);
			if (uParam1->f_10 == uParam1->f_11)
			{
				iVar1 = iVar0;
			}
			...
			*uParam3 = iVar1;
			iVar2 = func_271(bVar15, iVar16, iVar1);
			if (uParam1->f_14 == 0)
			{
	...
	if (func_264(iParam1))
	{
		switch (iVar1)
		{
			case 1:
				...
				if (func_272(bParam0, iParam1, 0))
				{
					iVar0 = (iVar0 + Global_262145.f_17144);
				}
				if (func_272(bParam0, iParam1, 1))
				{
...
struct<2> func_277(bool bParam0)
{
...
char* func_338()
{
	...
	if (bVar0 != func_10())
	{
		...
		{
			if (((func_36(bVar0, 28) || func_36(PLAYER::PLAYER_ID(), 28)) || func_343(bVar0)) && !func_342(bVar0))
			{
				return func_340(bVar0, 0);
			}
		...
		sVar1 = func_339(&(Global_1630816[bVar0 /*597*/].f_11.f_105));
...
void func_407(int iParam0, bool bParam1)
{
	...
	if (iParam1 != func_10())
	{
		if (NETWORK::NETWORK_IS_PLAYER_ACTIVE(iParam1))
		{
			...
			else if (func_408(bParam1, PLAYER::PLAYER_ID()))
			{
				iVar0 = 1;
			}
		}
...
int func_408(int iParam0, bool bParam1)
{
	...
	if (iParam0 != func_10() && bParam1 != func_10())
	{
...
void func_409(var uParam0, int* iParam1, int iParam2, var uParam3, var uParam4, int iParam5, bool bParam6, char* sParam7)
{
	...
	if (func_529() || iParam2 == 28)
	{
		...
		{
			func_483(1);
			if ((!func_482() && !func_481()) || MISC::IS_BIT_SET(Global_2544210.f_4655, true))
			{
				if (func_480())
				{
					func_479();
					...
					if (uParam3->f_27 == 0)
					{
						...
						while (iVar52 < 32)
						{
							...
							if ((func_468(iVar35) && func_464(iVar35, iParam2)) && func_9(iVar35, 0, 1))
							{
								...
								*(uParam4[iVar52 /*13*/]) = { func_184(bVar35) };
								iVar37 = func_453(bVar35);
								sVar36 = "";
								if (iVar37 != 0)
								{
								...
								iVar51 = func_446(bVar35, 0);
								if (bVar34)
								{
									if (func_28(bVar35, 1) && iVar1[iVar44] != -1)
									{
										iVar53 = iVar1[iVar44];
									}
									else
								...
								if (func_445(iParam5))
								{
									func_444(bVar35, iParam1, uParam3, iVar53, Var38, sVar36, iVar42, iVar43, iVar51, iVar50, fVar45, iVar43, iVar47, &Var57, (uParam0[iVar52 /*42*/])->f_40, iVar48, bParam6);
								}
								else
								{
									func_444(bVar35, iParam1, uParam3, iVar53, Var38, sVar36, iVar42, iVar43, iVar51, iVar50, fVar45, iVar46, iVar47, &Var57, (uParam0[iVar52 /*42*/])->f_40, iVar48, bParam6);
								}
						...
						while (iVar52 < 32)
						{
							...
							if (func_9(bVar35, 0, 1) && !MISC::IS_BIT_SET(iVar49, bVar35))
							{
								bVar35 = PLAYER::INT_TO_PLAYERINDEX(iVar52);
							}
							else
							...
							if (func_468(bVar35))
							{
								if (func_9(PLAYER::INT_TO_PLAYERINDEX(iVar52), 0, 1))
								{
									...
									*(uParam4[iVar52 /*13*/]) = { func_184(bVar35) };
									...
									uParam3->f_38[iVar44 /*2*/].f_1 = iVar53;
									func_424(bVar35, PLAYER::GET_PLAYER_NAME(bVar35), iParam1, uParam3, iVar53, Var38, sVar36, iVar42, iVar51, iVar50);
									iVar53++;
								}
							}
							iVar52++;
...
{
	if (func_437(bParam0) == 236 || func_437(bParam0) == 150)
	{
		return func_436(bParam0);
	}
	return 0;
}
...
int func_473(bool bParam0)
{
	...
	if ((NETWORK::_NETWORK_IS_PLAYER_EQUAL_TO_INDEX(iParam0, PLAYER::PLAYER_ID()) || func_32(bParam0) == 233) || func_32(bParam0) == 271)
	{
		return 1;
	}
	return 0;
...
bool func_476(var uParam0, bool bParam1)
{
...
int func_480()
{
	if (MISC::IS_BIT_SET(Global_2544210.f_4655, false) && func_345())
	{
		return 1;
	}
	if (MISC::IS_BIT_SET(Global_2544210.f_4655, true) && func_345())
	{
		return 1;
	}
	return 0;
...
void func_548(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	...
	{
		if (MISC::IS_BIT_SET(Global_2426865[Global_2441237.f_2012.f_703.f_16 /*449*/].f_417, false) && func_549())
		{
			iParam0 = 23;
		}
	}
...
void func_582(int iParam0, bool bParam1, int iParam2)
{
	...
	if (bParam1)
	{
		...
		else if (HUD::DOES_BLIP_EXIST(Global_2416162[iVar0]))
		{
			...
			MISC::CLEAR_BIT(&(Global_2416162.f_375), bVar0);
			HUD::SET_BLIP_FLASHES(Global_2416162[bVar0], true);
			HUD::SET_BLIP_FLASH_INTERVAL(Global_2416162[bVar0], 250);
			func_583(iParam0);
			if (iParam2 < 0)
			{
				MISC::SET_BIT(&(Global_2416162.f_375), bVar0);
			}
			else
			{
				Global_2416162.f_201[bVar0] = NETWORK::GET_TIME_OFFSET(NETWORK::GET_NETWORK_TIME(), iParam2);
			}
		}
		else
		{
			MISC::SET_BIT(&(Global_2416162.f_370), bVar0);
			MISC::CLEAR_BIT(&(Global_2416162.f_375), bVar0);
			if (iParam2 < 0)
			{
				MISC::SET_BIT(&(Global_2416162.f_375), bVar0);
	...
	if (!bParam1)
	{
		MISC::CLEAR_BIT(&(Global_2416162.f_370), bVar0);
		MISC::CLEAR_BIT(&(Global_2416162.f_375), bVar0);
		if (HUD::DOES_BLIP_EXIST(Global_2416162[bVar0]))
		{
			func_583(iParam0);
			HUD::SET_BLIP_FLASHES(Global_2416162[bVar0], false);
		}
	}
}
...
int func_584(bool bParam0)
{
	...
	if (func_9(iParam0, 0, 1))
	{
		if (HUD::DOES_BLIP_EXIST(Global_2416162[iVar0]))
		{
			...
			if (MISC::IS_BIT_SET(Global_2416162.f_386, iVar0) || MISC::IS_BIT_SET(Global_2416162.f_385, bVar0))
			{
				return 1;
			}
			else if ((MISC::IS_BIT_SET(Global_2416162.f_371, bVar0) || MISC::IS_BIT_SET(Global_2416162.f_370, bVar0)) || MISC::IS_BIT_SET(Global_2416162.f_388, bVar0))
			{
				return func_588(10);
			}
			else
			{
				switch (iVar1)
				{
					...
					case 271:
						if (PLAYER::GET_PLAYER_TEAM(bParam0) == PLAYER::GET_PLAYER_TEAM(Global_2441237))
						{
							return func_588(6);
						}
						else
					...
					case 163:
					case 164:
						if (func_81(Global_2441237, bParam0, -2, 0))
						{
							return func_588(6);
						}
						else
					...
					case 364:
						if (func_586(Global_2441237, bParam0, 1))
						{
							return func_588(10);
						}
						else
					...
					case 417:
						if ((func_373(bParam0) || func_585(bParam0)) || func_371(bParam0))
						{
							if (func_586(Global_2441237, bParam0, 1))
							{
								return 3;
						...
						else if (func_586(Global_2441237, bParam0, 1))
						{
							return func_588(6);
						}
						else
...
int func_592(var uParam0, var uParam1, int* iParam2, bool bParam3, bool bParam4, bool bParam5, var uParam6)
{
	if (bParam5)
	{
...
void func_602(char* sParam0, bool bParam1, int iParam2, bool bParam3)
{
...
void func_611()
{
	...
	if (MISC::IS_BIT_SET(Local_86.f_1, false))
	{
...
void func_617()
{
	...
	if (PLAYER::PLAYER_ID() != func_63())
	{
		if (MISC::IS_BIT_SET(iLocal_84, false))
		{
			if (!func_345())
			{
				sVar0 = "GBTER_START";
	...
	else if (MISC::IS_BIT_SET(iLocal_84, false))
	{
		if (!func_345())
		{
			sVar3 = "GBTER_BOSS";
...
void func_624()
{
	...
	while (iVar0 < 32)
	{
		...
		{
			if (func_48(bVar1, iVar2, 1) || func_625(bVar1, PLAYER::PLAYER_ID()))
			{
...
void func_710(int iParam0, bool bParam1, bool bParam2)
{
	...
	if ((iParam0 != 0 && NETWORK::NETWORK_IS_PLAYER_ACTIVE(iParam1)) && func_715(bParam1, 1))
	{
		switch (iParam0)
		{
			case 157:
