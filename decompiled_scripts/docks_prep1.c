...
void func_138(int iParam0, var uParam1)
{
	...
	if (!unk_0xECEC7528A52B4EE8(iParam0))
	{
		...
		while (iVar0 <= (44 - 1))
		{
			...
			if (iVar3 != 0)
			{
				Var4 = unk_0x2CBBA235A635CC58(iParam0, func_143(iVar0));
				Var4.f_1 = 0;
				Var4.f_2 = 0;
				Var4.f_3 = 0;
				Var4.f_4 = 0;
...
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_177(unk_0x234B68AC2E35ED5A(iParam0, 31), -1, 1)) + 2011;
}
...
int func_199()
{
	...
	switch (iLocal_410)
	{
		...
		case 4:
			...
			{
				fVar0 = (1f - func_203((SYSTEM::TO_FLOAT((unk_0xDFB7BFA6482FEE1E() - iLocal_2135 + 1500)) / 3000f), 0f, 1f));
...
void func_325()
{
	...
	unk_0x78B2DF314748056B(5, iLocal_395, 1862763509);
	unk_0x78B2DF314748056B(1, 1862763509, iLocal_394);
	unk_0x78B2DF314748056B(1, iLocal_394, 1862763509);
