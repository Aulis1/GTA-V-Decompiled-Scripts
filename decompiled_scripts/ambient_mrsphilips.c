...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		if (SYSTEM::VDIST2(unk_0xD6E677FAD7521410(unk_0x7D2B9E6A64637269(), 0), 1973.324f, 3815.594f, 31.42936f) < (fVar1 * fVar1))
		{
...
void func_60(int iParam0, var uParam1)
{
	...
	if (!unk_0xECEC7528A52B4EE8(iParam0))
	{
		...
		while (iVar0 <= (44 - 1))
		{
			...
			if (iVar3 != 0)
			{
				Var4 = unk_0x2CBBA235A635CC58(iParam0, func_65(iVar0));
				Var4.f_1 = 0;
				Var4.f_2 = 0;
				Var4.f_3 = 0;
				Var4.f_4 = 0;
...
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_101(unk_0x234B68AC2E35ED5A(iParam0, 31), -1, 1)) + 2011;
}
...
void func_114()
{
	...
	func_115(36);
	SYSTEM::START_NEW_SCRIPT(sVar0, 41500);
