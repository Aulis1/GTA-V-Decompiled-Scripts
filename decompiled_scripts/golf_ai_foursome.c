	...
	if (bParam2)
	{
		...
		if (func_3(func_327(uParam1, iVar1), func_41(uParam1, iVar1), &Var2, &fVar8, 0f, 0f, 0f, 0f, 0f, 0f, 0))
		{
			...
			while (iVar9 < 2)
			{
				...
				{
					if (!unk_0xE50EB54E0F21BED0(func_294(uParam0, iVar9), 0) && !unk_0x3D6C3476988DE6E1(Var2 + FtoV(SYSTEM::TO_FLOAT(iVar9)) * Var5, 5f))
					{
						unk_0x78CDDD1E6367978D(func_294(uParam0, iVar9), Var2 + FtoV(SYSTEM::TO_FLOAT(iVar9)) * Var5, 1, 0, 0, 1);
...
int func_3(struct<3> Param0, struct<2> Param3, var uParam5, var uParam6, float fParam7, struct<3> Param8, struct<2> Param11, float fParam13, bool bParam14)
{
	...
	while (!bVar0 && iVar1 < 10)
	{
		...
		else if ((SYSTEM::VDIST2(Param0, *uParam6) > 100f && !unk_0x4B1BAFAB7E8F4DA7(*uParam6, 5f)) && !func_7(*uParam6))
		{
	...
	if (unk_0x0BCA9ADE67DF9DD8((unk_0x832AD84AA258AE80((Param3 - Param0.x), (Param3.f_1 - Param0.f_1)) - *fParam7)) > 90f)
	{
...
int func_18(var uParam0, var uParam1)
{
	...
	if (SYSTEM::VDIST2(unk_0xD6E677FAD7521410(func_64(uParam0), 1), func_41(uParam1, func_313(uParam0))) < IntToFloat(iVar1))
	{
		if (unk_0x419E13582192CFEA(func_25(uParam0)) && !unk_0xE50EB54E0F21BED0(func_294(uParam0, func_253(uParam0)), 0))
		{
			if (SYSTEM::VDIST2(unk_0xD6E677FAD7521410(func_25(uParam0), 1), func_41(uParam1, func_313(uParam0))) > IntToFloat(iVar1))
			{
				return 1;
			}
	...
	if (SYSTEM::VDIST2(unk_0xD6E677FAD7521410(func_64(uParam0), 1), func_19(uParam0)) < IntToFloat(iVar0))
	{
		return 0;
	}
	return 1;
	...
	switch (func_34(uParam2))
	{
		...
		case 3:
			if (func_193(uParam2) || func_40(&(uParam2->f_15[func_270(uParam2) /*34*/]), 1048576))
			{
				...
				{
					if (SYSTEM::VDIST2(unk_0xD6E677FAD7521410(func_64(uParam2), 1), func_19(uParam2)) > 9f)
					{
...
void func_105(var uParam0, var uParam1, var uParam2)
{
	...
	if (func_110(uParam2))
	{
		unk_0x8543AEC08F877EE9(0, 50, func_108(0, func_109(256, (unk_0x909F156FC4077611(SYSTEM::ROUND(uParam2->f_1.f_6)) + unk_0x909F156FC4077611(SYSTEM::ROUND(uParam2->f_1.f_5))) + 30)));
	}
	if (!func_275(uParam2, 2))
	{
		...
		if (unk_0x7919C1F1872DDE8E(iVar0) && func_257(&(uParam2->f_159), 0.2f))
		{
			...
			func_78(uParam2, SYSTEM::VDIST(unk_0xD6E677FAD7521410(iVar0, 1), func_19(uParam2)));
			func_74(uParam2, 2);
			func_169(&(uParam2->f_159));
			func_106(uParam2);
		}
...
void func_114(var uParam0)
{
	...
	Var3 = { -Var0 };
	if (unk_0x0BCA9ADE67DF9DD8(uParam0->f_5) < unk_0x0BCA9ADE67DF9DD8(Var0.x))
	{
		uParam0->f_5 = 0f;
	}
	else
...
int func_126(var uParam0, var uParam1, var uParam2)
{
	...
	else
	{
		...
		if (unk_0x0BCA9ADE67DF9DD8(fVar27) < SYSTEM::COS(15f))
		{
			Var24 = { func_131(Var24, (fVar28 * (unk_0xF53829643801155A(unk_0x0BCA9ADE67DF9DD8(fVar27)) - 15f))) };
		}
		Var18.f_1 = ((Var24.f_1 / unk_0x0BCA9ADE67DF9DD8(Var24.f_1)) * SYSTEM::SQRT(unk_0x0BCA9ADE67DF9DD8((((Var18.f_2 * Var18.f_2) - 1f) / (((Var24.x * Var24.x) / (Var24.f_1 * Var24.f_1)) + 1f)))));
...
float func_141(float fParam0, float fParam1)
{
	...
	fVar0 = SYSTEM::SIN(unk_0x644B8DBA4F69BB73(-180f, 180f));
	if (fVar0 < 0f)
	{
		fVar0 = (fVar0 + 1f);
	}
...
void func_157(var uParam0, var uParam1, var uParam2, bool bParam3, bool bParam4)
{
	...
	if (uParam2->f_12 > 0)
	{
		uParam2->f_12 = (uParam2->f_12 + SYSTEM::FLOOR((unk_0x7FF6ACE380ED166C() * 1000f)));
	}
...
void func_254(var uParam0, int iParam1, var uParam2, bool bParam3, bool bParam4)
{
	...
	fVar1 = 144f;
	bVar10 = SYSTEM::VDIST2(unk_0xD6E677FAD7521410(func_294(uParam0, func_272(uParam0, iParam1)), 1), uParam0->f_15[iParam1 /*34*/].f_10) < fVar1;
	...
	if (bVar10)
	{
		...
		else if ((SYSTEM::VDIST2(func_265(uParam0, iParam1), func_41(uParam2, func_313(uParam0))) < 1600f && SYSTEM::VDIST2(unk_0xD6E677FAD7521410(func_274(uParam0, iParam1), 1), func_41(uParam2, func_313(uParam0))) < 1600f) && !func_298(uParam0, iParam1, 67108864))
		{
	...
	if (SYSTEM::VDIST2(Var0, Var3) > (150f * 150f))
	{
		...
		if (Var0.f_2 > 100f)
		{
			if (unk_0x419E13582192CFEA(uParam0->f_3))
			{
				...
				{
					unk_0x78CDDD1E6367978D(uParam0->f_3, Var0.x, Var0.f_1, 50f, 1, 0, 0, 1);
				}
			}
		}
	}
