...
int func_184(var uParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8)
{
	...
	if (func_175(2))
	{
		if (!func_146())
		{
			if (((func_127(unk_0x7D2B9E6A64637269()) && func_127(uParam0->f_28[0])) && (unk_0xDFB7BFA6482FEE1E() - uParam0->f_60) > iParam8) && func_190(unk_0x7D2B9E6A64637269(), Param1, 1) < 20f)
			{
				uVar0 = 16;
		...
		else if (func_185(sParam5))
		{
			...
			{
				if (func_190(unk_0x7D2B9E6A64637269(), Param1, 1) >= 20f)
				{
					func_144();
				}
			}
...
void func_191(int iParam0, var uParam1, var uParam2, struct<3> Param3, struct<3> Param6, struct<3> Param9)
{
	...
	if (unk_0xCAD1755E530A6012(unk_0x1146A9AE09CE2B14()))
	{
		if (!unk_0xAB6A270F84A8781E(uParam2))
		{
			...
			{
				if (func_190(unk_0x7D2B9E6A64637269(), Param3, 1) <= 100f)
				{
					func_194(iParam0, 1);
				}
			}
			else
			{
				...
				{
					fVar0 = func_190(unk_0x7D2B9E6A64637269(), Param6, 1);
					fVar1 = func_190(unk_0x7D2B9E6A64637269(), Param9, 1);
					fVar2 = (fVar0 - fVar1);
					if (fVar2 < 0f)
					{
						fVar2 = (fVar2 * -1f);
					...
					if (fVar2 > 0.5f)
					{
						if (fVar0 < fVar1)
						{
							...
							{
								unk_0xCB63763717A253D9();
								unk_0xFA3CD2A976F07F94(uParam2, 5, 8);
								func_192(*iParam0, 1);
								*uParam1 = 1;
							}
						}
						...
						{
							unk_0xCB63763717A253D9();
							unk_0xFA3CD2A976F07F94(uParam2, 6, 8);
							func_192(*iParam0, 1);
							*uParam1 = 2;
						}
					}
				}
				if (func_190(unk_0x7D2B9E6A64637269(), Param3, 1) > 120f)
				{
					func_195(iParam0);
				}
			}
...
int func_238(var uParam0)
{
	...
	switch (iLocal_91)
	{
		...
		case 1:
			if (((!func_241(&iVar0) || !unk_0x0EC2B29D4172D225("rcmlastone1")) || !unk_0x13A4C28F44262AD2(joaat("weapon_pumpshotgun"))) || !unk_0x13A4C28F44262AD2(joaat("weapon_sniperrifle")))
			{
				return 0;
			}
			iLocal_91 = 2;
		...
		case 2:
			bVar5 = true;
			uParam0->f_28[0] = unk_0x0FDCFECB2EF2BC1C(25, iLocal_92, -1299.02f, 4639.86f, 106.66f, 345.7769f, 1, 1);
