...
void func_12(char* sParam0, var uParam1, char* sParam2)
{
	...
	if (!func_53(uParam1->f_22, 0f, 0f, 0f, 0))
	{
		...
		unk_0xB7D390F8F682127B(uParam1->f_5 + uParam1->f_19, (SYSTEM::VMAG(uParam1->f_22) + 25f), 0, 0, 0, 0, 0, 0);
		unk_0x6AF7EE4DD9F8B944(uParam1->f_5 + uParam1->f_19, (SYSTEM::VMAG(uParam1->f_22) + 25f), 1, 0, 0, 0);
	}
	if (!unk_0xE50EB54E0F21BED0(unk_0x7D2B9E6A64637269(), 0))
	{
...
int func_57(struct<3> Param0, var uParam3, int iParam4, int iParam5)
{
	if (unk_0xCAD1755E530A6012(unk_0x1146A9AE09CE2B14()))
	{
		...
		while ((!unk_0xCF371493BAEB8860() && !func_58()) && SYSTEM::TIMERA() < 1500)
		{
			SYSTEM::WAIT(0);
		}
