	...
	while (iVar0 != 7)
	{
		...
		switch (iVar0)
		{
			...
			case 4:
				...
				unk_0x78B2DF314748056B(5, uLocal_49, 1862763509);
...
int func_60(int iParam0, var uParam1)
{
	switch (iLocal_255)
	{
		...
		case 3:
			...
			{
				if (SYSTEM::TIMERA() > 8000 && unk_0x591190E69BE43117(iParam0, Local_243, 3f, 3f, 3f, 0, 1, 0))
				{
...
int func_74(struct<3> Param0, int iParam3)
{
	if (!unk_0xECEC7528A52B4EE8(unk_0x7D2B9E6A64637269()))
	{
		if (SYSTEM::VDIST(unk_0xD6E677FAD7521410(unk_0x7D2B9E6A64637269(), 1), Param0) > IntToFloat(iParam3))
		{
			return 1;
		}
	}
...
int func_101()
{
	...
	{
		if (SYSTEM::VDIST2(unk_0xD6E677FAD7521410(unk_0x7D2B9E6A64637269(), 1), Local_46) < (75f * 75f))
		{
			return 1;
		}
		if (SYSTEM::VMAG2(unk_0x9F2928DF31D785C7(unk_0x7D2B9E6A64637269())) > 1369f && !func_112())
		{
			return 0;
		}
	}
...
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_133(unk_0x234B68AC2E35ED5A(iParam0, 31), -1, 1)) + 2011;
}
