...
{
	return unk_0x8954E9D0A9F6F8CF(uParam0, 355.6093f, 4832.486f, -59.99951f, 338.4763f, 4841.36f, -56.99947f, 15f, 0, 1, 0);
}
...
int func_73()
{
	if (Global_1590751 != func_60())
	{
		if (unk_0x3F466B2A5F02D328("base_corridor_seats", Global_1590751, 1, 0))
		{
			return 0;
		}
